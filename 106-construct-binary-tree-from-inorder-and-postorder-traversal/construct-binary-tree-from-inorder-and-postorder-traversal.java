...
class Solution {
    ...
    Map<Integer, Integer> inMap) {
        ...
        root.left = buildTree(inorder, inStart, inRoot-1, postorder, pStart, pStart+l-1, inMap);
        root.right = buildTree(inorder, inRoot+1, inEnd, postorder, pStart+l, pEnd-1, inMap);
